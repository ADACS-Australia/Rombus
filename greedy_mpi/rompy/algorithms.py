...
class StandardRB(ReducedBasis, IteratedModifiedGramSchmidt):
	...
	#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	
	def __init__(self, Nbasis, Npoints, Nquads, inner, inner_type, Nmodes=1, norms=None, dtype='complex'):
	...
	def iter(self, step, errs, trsp):
		...
		self.basis[step+1], self.basisnorms[step+1] = self.add_basis(trsp[self.indices[step+1]], self.basis[:step+1])
...
class StandardRBEIM(ReducedBasis, EmpiricalInterpolation):
	...
	#!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	
	def __init__(self, Nbasis, Npoints, Nquads, inner, inner_type, Nmodes=1, norms=None, dtype='complex'):
		self.rb = StandardRB(Nbasis, Npoints, Nquads, inner, inner_type, Nmodes=Nmodes, norms=norms, dtype=dtype)
